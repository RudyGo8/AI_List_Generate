...
def main():
    parser = argparse.ArgumentParser(description='Enterprise-style AI API evaluator')
    ...
    parser.add_argument('--shop-dataset', default='app/eval/datasets/shop_eval.jsonl')
    ...
    parser.add_argument('--out', default='app/eval/reports/latest_report.json')
