...
const spuImageUrl = ref('https://raw.githubusercontent.com/RudyGo8/RudyGo8/refs/heads/main/8.jpg')
const productTitle = ref('Portable Bluetooth Speaker')
const categoryName = ref('Electronics > Audio')
const noticeUrl = ref('')
